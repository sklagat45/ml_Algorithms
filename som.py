...
time_constant = n_iterations / np.log(radius)
...
if normalise_data:
    if normalise_by_column:
        ...
        data = raw_data / data.max() #normalization of data

net = np.random.random((dimensions[0], dimensions[1], m))
...
for i in range(n_iterations):
    ...
    r = decay_radius(radius, i, time_constant)
    l = decay_learning_rate(learning_rate, i, n_iterations)
